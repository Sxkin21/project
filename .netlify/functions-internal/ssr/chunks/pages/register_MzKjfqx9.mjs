/* empty css                             */
import { e as createAstro, f as createComponent, r as renderTemplate, i as renderHead } from '../astro_Ce5QnvEV.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
...
const $$Register = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (Astro2.request.method === "POST") {
    ...
    const emailData = await db.select().from(users).where(isNotNull(users.email));
